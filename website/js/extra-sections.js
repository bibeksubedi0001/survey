...
(function () {
  ...
  const SECTIONS = {
    chief: {
      ...
      fields: [
        { group: 'Reporter & Time', key: 'reportedBy', label: 'Reported By',          type: 'text',     placeholder: 'Officer name' },
        { group: 'Reporter & Time', key: 'reportedAt', label: 'Date / Time',          type: 'datetime' },
        { group: 'Location',        key: 'location',   label: 'Location (Address / Landmark)', type: 'text', full: true, placeholder: 'e.g. Baneshwor Chowk, Ward 10' },
        { group: 'Location',        key: 'gps',        label: 'GPS Coordinates',        type: 'location', full: true, required: true },
        { group: 'Findings',        key: 'issue',      label: 'Primary Issue',        type: 'select',   options: ['No Water Supply','Low Pressure','Leakage','Pipe Burst','Blockage','Contamination','Meter Fault','Billing Dispute','Illegal Connection','Other'] },
    ...
    leak: {
      ...
      fields: [
        { group: 'Reporter & Time', key: 'reportedBy', label: 'Reported By',     type: 'text', placeholder: 'Field officer name' },
        { group: 'Reporter & Time', key: 'reportedAt', label: 'Date Observed',   type: 'datetime' },
        { group: 'Location',        key: 'location',   label: 'Location / Landmark', type: 'text', full: true, placeholder: 'e.g. New Baneshwor near Everest Hotel' },
        { group: 'Location',        key: 'gps',        label: 'GPS Coordinates',   type: 'location', full: true, required: true },
    ...
    pressure: {
      ...
      sheetName: 'Pressure',
      fields: [
        { group: 'Reporter & Time', key: 'reportedBy', label: 'Measured By', type: 'text' },
        { group: 'Reporter & Time', key: 'reportedAt', label: 'Date / Time', type: 'datetime' },
        { group: 'Location & Zone', key: 'location',   label: 'Location / Landmark', type: 'text', full: true },
        { group: 'Location & Zone', key: 'gps',        label: 'GPS Coordinates', type: 'location', full: true, required: true },
        ...
        { group: 'Measurement',     key: 'pressure',   label: 'Pressure Reading', type: 'number', placeholder: 'Value' },
    ...
    area: {
      ...
      fields: [
        { group: 'Reporter & Time', key: 'reportedBy', label: 'Surveyor', type: 'text' },
        { group: 'Reporter & Time', key: 'reportedAt', label: 'Date / Time', type: 'datetime' },
        { group: 'Area Details',    key: 'area',       label: 'Area / Tole', type: 'text', placeholder: 'e.g. New Baneshwor' },
        ...
        { group: 'Area Details',    key: 'gps',        label: 'GPS Coordinates', type: 'location', full: true, required: true },
